...
Stage createMap_TestAll() {
    ...
    tiles.emplace_back(3, sf::Vector2f{160.f, 20.f}, sf::Vector2f{120.f, 320.f}, StageObjectType::SemiSolid);
    tiles.emplace_back(4, sf::Vector2f{160.f, 20.f}, sf::Vector2f{520.f, 260.f}, StageObjectType::SemiSolid);
    ...
    tiles.emplace_back(6, sf::Vector2f{80.f, 20.f}, sf::Vector2f{600.f, 530.f}, StageObjectType::Hazard);

    // === Side walls ===
    tiles.emplace_back(7, sf::Vector2f{40.f, 600.f}, sf::Vector2f{-40.f, 0.f}, StageObjectType::Hazard);
    tiles.emplace_back(8, sf::Vector2f{40.f, 600.f}, sf::Vector2f{800.f, 0.f}, StageObjectType::Hazard);
